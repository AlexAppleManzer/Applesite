...
@Component({
  selector: 'app-tft-leaderboard',
  templateUrl: './tft-leaderboard.component.html',
  styleUrls: ['./tft-leaderboard.component.css']
})
export class TftLeaderboardComponent implements AfterViewInit {
  summoners : any[] = [];
    ...
    merge(this.paginator.page)
      .pipe(
        ...
        switchMap(() => {
          ...
          return this.leagueService.querySummoners({'sortByTFT': '-1', page: this.paginator.pageIndex, limit: this.paginator.pageSize});
